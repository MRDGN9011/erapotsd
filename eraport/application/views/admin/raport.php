    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <div class="text-center">
                <h2>LAPORAN ONLINE</h2>
                <h2>PENCAPAIAN KOMPETENSI PESERTA DIDIK</h2>
                <h2>SEMESTER <?= $semester ?></h2>
                <h2>TAHUN PELAJARAN <?= $tahun_ajaran ?></h2>
            </div>
            <br>
            ...
            <div>
                ...
                <table class="table table-bordered" width="100%" cellspacing="0" style="text-align: center;">
                    ...
                    <a target='_blank' href="<?= site_url('admin/cetakraport/' . $id_siswa . '/' . $id_kelas . '/' . $id_semester) ?>" class="btn btn-primary btn-block">Cetak Raport</a>
                </div>
            </div>
        </div>
