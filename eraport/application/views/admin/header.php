        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class="sidebar-brand-icon rotate-n-0">
                    ...
                    <img width="50%" src="<?= base_url('assets/image/'. $profile->logo) ?>">
                </div>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url("admin/semester"); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url("admin/datasemestersiswa"); ?>">
                    <i class="fas fa-fw fa-plus-circle"></i>
                    <span>Kelola Nilai Raport</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url("admin/datanilai"); ?>">
                    <i class="fas fa-fw fa-list"></i>
                    <span>Data Nilai Raport</span></a>
            </li>
