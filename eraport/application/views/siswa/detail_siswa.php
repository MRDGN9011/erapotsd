                            ...
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th> : </th>
                                        <td>
                                            <form class="form" action="<?= site_url('siswa/upload_kk/' . $id_siswa) ?>" method="post" enctype="multipart/form-data">
                                                <?php if ($kk) { ?>
                                                    <a target="_blank" href="<?= base_url('assets/image/berkassiswa/' . $kk) ?>"><img width="15%" src="<?= base_url('assets/image/berkassiswa/' . $kk) ?>"></a>
                                                    <br><br>
                                                <?php } else { ?>
                                    ...
                                    <tr>
                                        ...
                                        <th> : </th>
                                        <td>
                                            <form class="form" action="<?= site_url('siswa/upload_akta_lahir/' . $id_siswa) ?>" method="post" enctype="multipart/form-data">
                                                <?php if ($akta_lahir) { ?>
                                                    <a target="_blank" href="<?= base_url('assets/image/berkassiswa/' . $akta_lahir) ?>"><img width="15%" src="<?= base_url('assets/image/berkassiswa/' . $akta_lahir) ?>"></a>
                                                    <br><br>
                                                <?php } else { ?>
                                    ...
                                    <tr>
                                        ...
                                        <th> : </th>
                                        <td>
                                            <form class="form" action="<?= site_url('siswa/upload_ijazah_sd/' . $id_siswa) ?>" method="post" enctype="multipart/form-data">
                                                <?php if ($ijazah_sd) { ?>
                                                    <a target="_blank" href="<?= base_url('assets/image/berkassiswa/' . $ijazah_sd) ?>"><img width="15%" src="<?= base_url('assets/image/berkassiswa/' . $ijazah_sd) ?>"></a>
                                                    <br><br>
                                                <?php } else { ?>
                                    ...
                                    <tr>
                                        ...
                                        <th> : </th>
                                        <td>
                                            <form class="form" action="<?= site_url('siswa/upload_form_daftar/' . $id_siswa) ?>" method="post" enctype="multipart/form-data">
                                                <?php if ($form_daftar) { ?>
                                                    <a target="_blank" href="<?= base_url('assets/image/berkassiswa/' . $form_daftar) ?>"><img width="15%" src="<?= base_url('assets/image/berkassiswa/' . $form_daftar) ?>"></a>
                                                    <br><br>
                                                <?php } else { ?>
