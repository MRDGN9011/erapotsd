    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <form class="form" action="<?= site_url('siswa/upload_ktp_ayah/' . $id_siswa) ?>" method="post" enctype="multipart/form-data">
                    ...
                    <form class="form" action="<?= site_url('siswa/upload_ktp_ibu/' . $id_siswa) ?>" method="post" enctype="multipart/form-data">
