    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3"> Ruang Guru </div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url("guru/guru"); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url("guru/datasemestersiswa"); ?>">
                    <i class="fas fa-fw fa-plus-circle"></i>
                    <span>Kelola Nilai</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url("guru/datanilai"); ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="<?php echo base_url("assets/image/fotoguru/" . $this->session->foto_guru); ?>">
                            </a>
